...
<div class="clearfix">	
	...
	<div>
		...
		<div class="alert alert-info">
			<a href="<?php  echo url('system/service/import')?>">存在可用的服务, 点击这里快速导入</a>
		</div>
		<?php  } ?>
		...
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				...
				<div class="btn-group pull-right">
					<a class="btn btn-default btn-xs" href="<?php  echo url('system/service/post', array('rid' => $row['id'],'m'=>$row['module']))?>"><i class="fa fa-edit"></i> 编辑</a>
					<a class="btn btn-default btn-xs" onclick="return confirm('删除规则将同时删除关键字与回复，确认吗？');return false;" href="<?php  echo url('system/service/delete', array('rid' => $row['id']))?>"><i class="fa fa-times"></i> 删除</a>
				</div>
			</div>
			<div class="panel-body">
